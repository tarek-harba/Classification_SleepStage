...
def main():
    ...
    parser.add_argument("--data_dir",
                        type=str,
                        default=r"C:\Users\Doppler\PycharmProjects\ML_Paper_SleepClassification\preprocess\Final Downloaded Data\data_edf_78 - edf",
                        help="File path to the PSG and annotation files.")
    parser.add_argument("--output_dir",
                        type=str,
                        default=r"C:\Users\Doppler\PycharmProjects\ML_Paper_SleepClassification\preprocess\Final Downloaded Data\data_edf_78 - npz/fpzcz",
    ...
    for i in range(len(psg_fnames)):
        ...
        raw_ch_df = raw.to_data_frame(scalings=100.0)[select_ch] # scaling_time --> scalings
        ...
        for a in ann[0]:
            ...
            if label != UNKNOWN:
                ...
                label_epoch = np.ones(duration_epoch, dtype=np.int64) * label #from .int to .int64
                labels.append(label_epoch)
                idx = int(onset_sec * sampling_rate) + np.arange(duration_sec * sampling_rate, dtype=np.int64) #from .int to .int64
