...
class ModelOrange(nn.Module):
    # MRCNN+TCE
    """
    ModelCyan: A neural network model combining MRCNN, TCE modules as described in authors' paper.

    Attributes:
        module1 (nn.Module): Instance of the `MRCNN` class.
        module2 (nn.Module): Instance of the `TCE` class.
